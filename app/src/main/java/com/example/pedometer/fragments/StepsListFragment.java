...
public class StepsListFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>, AbsListView.MultiChoiceModeListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String[] from = {Provider.Pedometer.CREATION_DATE, Provider.Pedometer.STEPS_COUNT};
        int[] to = {R.id.StepItemTextView1, R.id.StepItemTextView2};

        stepsGridView = v.findViewById(R.id.notesGridView);
        gridViewAdapter = new CustomAdapter(getContext(),
                R.layout.pedometer_item, Defaults.NO_CURSOR, from, to, Defaults.NO_FLAGS);
    ...
    public Loader<Cursor> onCreateLoader(int i, @Nullable Bundle bundle) {
        ...
        loader.setUri(PedometerContentProvider.CONTENT_URI);
